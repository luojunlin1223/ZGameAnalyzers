...
### ZGameAnalyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [ZGameAnalyzers.Sample.csproj](../ZGameAnalyzers.Sample/ZGameAnalyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### ZGameAnalyzers.Tests
